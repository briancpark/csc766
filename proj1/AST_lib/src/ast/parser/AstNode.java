...
abstract public class AstNode extends AttributedNode implements Cloneable {
    ...
    public AstNode GetParentAst() {return parentAst;}
    void SetParentAst(AstNode par) {parentAst = par;}
    ...
    AstNode GetChild(int i) {return (AstNode) children.elementAt(i);}
    ...
    public AstNode(String nn) {
        nodeName=nn; children = new Vector(); }
