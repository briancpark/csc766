...
public class AssignStat extends StatAst {
    public AssignStat(String nm) {super(nm);}
    // Addressable leftHandOp;
    // Calculable rightHandOp;
    public Addressable GetLeftHandOp() {return (Addressable) GetChild(0);}
    public Calculable GetRightHandOp() {return (Calculable) GetChild(1);}
